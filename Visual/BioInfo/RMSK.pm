package BioFuse::Visual::BioInfo::RMSK;
...
use BioFuse::Visual::ArrangeObj qw/ allocate_object_vertical get_ObjSpanPixItval /;
require Exporter;
...
$MODULE_NAME = 'BioFuse::Visual::BioInfo::RMSK';
#----- version --------
$VERSION = "0.03";
$DATE = '2019-02-24';
